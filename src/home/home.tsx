    ...
    return (
        <div className='whole'>
            <div className='me'>
                ...
                {/* <a className='git' href="https://github.com/acodjoe25">See my GitHub!</a>
                <a className='link' href="https://www.linkedin.com/in/ariana-codjoe-771603230/">Connect one Linkedin!</a> */}
            </div>
        ...
        Overall, I find software engineering's dynamic nature, collective accomplishments, and opportunities for personal growth and creativity a perfect fit for my diverse interests and strengths.
                </p>
            </div>
        </div>
    );
